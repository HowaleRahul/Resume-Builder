        ...
        <header className="h-20 bg-white border-b border-slate-200 px-8 flex items-center shrink-0">
          <div className="flex items-center flex-1">
             <div className="relative w-full max-w-2xl">
               ...
               <input 
                 type="text" 
                 placeholder="Search your career universe..." 
                 className="w-full bg-slate-50 border border-slate-200 rounded-2xl pl-12 pr-6 py-3 text-sm font-medium focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all shadow-sm"
                 value={searchQuery}
                 onChange={e => setSearchQuery(e.target.value)}
               />
             </div>
          </div>
          {/* Redundant Profile Removed - Covered by Global Header */}
        </header>
