      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-xl text-slate-500 max-w-2xl mx-auto mb-14 leading-relaxed font-medium">
            Stop fighting LaTeX templates. CareerFlow AI parses your expertise into high-fidelity, ATS-optimized PDFs tailored for the world's elite engineering teams.
          </p>
